...
func TestInsertionSort(t *testing.T) {
	for _, tc := range []struct {
		...
		{"6", List(1, 3), List(1, 3)},
		{"7", List(3, 1), List(1, 3)},
		{"8", List(1, 2, 3), List(1, 2, 3)},
		{"9", List(1, 3, 2), List(1, 2, 3)},
		{"10", List(2, 1, 3), List(1, 2, 3)},
		{"11", List(2, 3, 1), List(1, 2, 3)},
		{"12", List(3, 2, 1), List(1, 2, 3)},
		{"13", List(3, 1, 2), List(1, 2, 3)},
		{"14", List(1, 2, 1), List(1, 1, 2)},
		{"15", List(3, 5, 4, 1, 2, 9, 12, 7), List(1, 2, 3, 4, 5, 7, 9, 12)},
		{"16", List(5, 3, 12, 9, 0, 5, 9, 2, 22, 1, 0, 90, 4, 6), List(0, 0, 1, 2, 3, 4, 5, 5, 6, 9, 9, 12, 22, 90)},
	} {
